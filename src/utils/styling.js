...
export const COLOR_VARIANTS = {
    ...
    primary: {
        soft: {
            ...
            activeBg: "bg-primary-600 dark:bg-primary-800",
            activeText: "text-white dark:text-primary-50",
            activeBorder: "border-primary-100 dark:border-primary-600",
    ...
    red: {
        ...
        solid: {
            ...
            text: "text-red-50 dark:text-white",
    ...
    green: {
        soft: {
            bg: "bg-green-400/55 dark:bg-green-600/35",
            text: "text-green-900 dark:text-white",
            border: "border-green-500 dark:border-green-700",
            hoverBg: "hover:bg-green-100/55 dark:hover:bg-green-700/40",
            ...
            activeBg: "bg-green-600 dark:bg-green-800",
            activeText: "text-white dark:text-green-50",
            activeBorder: "border-green-100 dark:border-green-600",
        ...
        solid: {
            ...
            text: "text-green-50 dark:text-white",
    ...
    blue: {
        ...
        solid: {
            ...
            text: "text-blue-50 dark:text-white",
    ...
    yellow: {
        soft: {
            bg: "bg-yellow-400/55 dark:bg-yellow-600/35",
            text: "text-yellow-900 dark:text-white",
            border: "border-yellow-500 dark:border-yellow-700",
            hoverBg: "hover:bg-yellow-100/55 dark:hover:bg-yellow-700/40",
            ...
            activeBg: "bg-yellow-600 dark:bg-yellow-800",
            activeText: "text-white dark:text-yellow-50",
            activeBorder: "border-yellow-100 dark:border-yellow-600",
        ...
        solid: {
            ...
            text: "text-yellow-50 dark:text-white",
    ...
    orange: {
        soft: {
            bg: "bg-orange-400/55 dark:bg-orange-600/35",
            text: "text-orange-900 dark:text-white",
            border: "border-orange-500 dark:border-orange-700",
            hoverBg: "hover:bg-orange-100/55 dark:hover:bg-orange-700/40",
            ...
            activeBg: "bg-orange-600 dark:bg-orange-800",
            activeText: "text-white dark:text-orange-50",
            activeBorder: "border-orange-100 dark:border-orange-600",
        ...
        solid: {
            ...
            text: "text-orange-50 dark:text-white",
    ...
    purple: {
        soft: {
            bg: "bg-purple-400/55 dark:bg-purple-600/35",
            text: "text-purple-900 dark:text-white",
            border: "border-purple-500 dark:border-purple-700",
            hoverBg: "hover:bg-purple-100/55 dark:hover:bg-purple-700/40",
            ...
            activeBg: "bg-purple-600 dark:bg-purple-800",
            activeText: "text-white dark:text-purple-50",
            activeBorder: "border-purple-100 dark:border-purple-600",
        ...
        solid: {
            ...
            text: "text-purple-50 dark:text-white",
    ...
    pink: {
        ...
        solid: {
            ...
            text: "text-pink-50 dark:text-white",
