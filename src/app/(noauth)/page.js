    ...
    return (
        <main className="flex items-center flex-col w-full">
            ...
            <div className="flex items-center flex-col w-full z-10">
                ...
                <div
                    className="flex flex-col items-center bg-linear-to-b from-green-100 dark:from-green-900/45 to-bg-0 dark:to-bg-900 w-full pb-10">
                    <div className="flex flex-col pt-32 gap-5 w-3/5 max-xl:w-4/6 max-lg:w-4/5 max-sm:w-5/6" id="how-it-works">
                        <h3 className="text-4xl font-semibold text-start mb-0 text-gray-800 dark:text-gray-100">
                            {howItWorks.title}
                            <span
                                className="text-xl opacity-50 font-normal ml-5 bg-linear-to-r from-bg-800 dark:from-bg-100 from-20% to-bg-900 dark:to-bg-0 to-80% bg-clip-text text-transparent">
                                {howItWorks.subtitle}
                            </span>
                        </h3>
                        <BadgeCarousel
