...
<p>
    Runway follows a typical [Next.js](http://nextjs.org) project structure with some custom organization. If you're unfamiliar with Next.js, I recommend checking out their [project structure documentation](https://nextjs.org/docs/getting-started/project-structure) for a solid foundation.
