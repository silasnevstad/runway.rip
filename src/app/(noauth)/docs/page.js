        ...
        <div className="w-full h-full min-h-screen md:mt-5 lg:mt-14 max-md:p-2">
            ...
            <div className="flex flex-col gap-4 mb-6 w-full">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <TutorialCard title="Deploying Models" description="Deploy your models with Runway" href="/docs/deploying-models"  />
                    <TutorialCard title="Custom Models" description="Create your own custom models" href="/docs/custom-models" />
                </div>
            </div>
