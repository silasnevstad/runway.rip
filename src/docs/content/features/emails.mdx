...
<div className="flex items-center">
    <TutorialGuide options={[
        ...
        <div id="resend">
            ...
            4. Go to [API Keys](https://resend.com/api-keys) in the sidebar and click **Create API Key**. Add this to the `.env.local` file as `RESEND_API_KEY`.
        ...
        <div id="mailgun">
            ...
            4. Navigate to [API Security](https://app.mailgun.com/settings/api_security) and click **Add new Key**, then add this to the `.env.local` as `MAILGUN_API_KEY`.
