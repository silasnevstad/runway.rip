...
<Info>
    ...
    - We create a function to automatically add a profile when a new user signs up (if using payments, it also creates a Stripe customer and adds the `customer_id`).
