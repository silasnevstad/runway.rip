...
| Key               | Description                                                                                           |
|-------------------|-------------------------------------------------------------------------------------------------------|
| `supportEmail`    | The email address for support.                                                                        |
| `noReplyEmail`    | The email address for no-reply emails.                                                                |
...
| Key                     | Description                                                                       |
|-------------------------|-----------------------------------------------------------------------------------|
| `waitlistMode`          | If true, the app will be in waitlist mode.                                        |
| `waitlistAllowedRoutes` | An array of routes that are allowed to be accessed without being on the waitlist. |
| `waitlistRedirect`      | The path to redirect to if the user is not on the waitlist.                       |
...
| Key                  | Description                                                               |
|----------------------|---------------------------------------------------------------------------|
| `requiredCustomerId` | If true, the app will require a customer ID to create a checkout session. |
| `afterCheckoutPath`  | The path to redirect to after a successful checkout.                      |
