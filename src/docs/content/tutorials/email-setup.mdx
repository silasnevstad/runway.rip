...
<div className="flex items-center">
    <TutorialGuide options={[
        ...
        <div id="resend">
            ...
            4. Go to **API Keys** in the sidebar and click **Create API Key**. Add this to the `.env.local` file as `NEXT_PUBLIC_RESEND_API_KEY`.
        </div>
        ...
        <div id="mailgun">
            ...
            4. Click your account in the top right and select **API Security** > **Add new Key**, then add this to the `.env.local` as `NEXT_PUBLIC_MAILGUN_API_KEY`.
