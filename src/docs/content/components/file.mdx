...
| iconColor        | string            | `"primary"` | The color of the file icon (uses [tailwind.config](/docs/tutorials/config#color-theme)). |
...
| borderColor      | string            | `"gray"`    | The base color (uses [tailwind.config](/docs/tutorials/config#color-theme)).             |
