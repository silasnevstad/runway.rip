...
| color            | string            | `"bg"`      | The base color (uses [tailwind.config](/docs/features/config#color-theme)).             |
| variant          | "soft" \| "solid" | `"solid"`   | The variant of the component.                                               |
| iconColor        | string            | `"primary"` | The color of the file icon (uses [tailwind.config](/docs/features/config#color-theme)). |
...
| borderColor      | string            | `"gray"`    | The base color (uses [tailwind.config](/docs/features/config#color-theme)).             |
