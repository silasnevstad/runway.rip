...
<Input
    ...
    placeholder="Floating label"
    labelMode="float"
    labelBackground="dark:bg-bg-900"
/>
```
</PreviewCode>
...
<PreviewCode preview={
    <div className="flex flex-col gap-5">
        ...
        <Input
            id="custom"
            label="Custom Input"
            className="border-blue-500 dark:border-blue-500 bg-blue-400/50"
            textClassName="placeholder:text-blue-500 text-blue-500"
            activeColor="blue"
            size="md"
            placeholder="Custom styled input"
        />
        <Input
            id="custom"
            label="Custom Input"
            className="border-2 border-green-500 dark:border-green-500 bg-green-400/50"
            textClassName="placeholder:text-green-500 text-green-500"
            activeColor="green"
            size="lg"
            borderRadius="full"
            placeholder="Custom styled input"
