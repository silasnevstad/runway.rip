...
<div className="flex flex-col items-center gap-0">
    ...
    <TextLink href="/docs/components/text-link" scale>
        Grow
    </TextLink>
    <TextLink href="/docs/components/text-link" lift>
        Lift
    </TextLink>
...
| selected           | boolean | `false` | If `true`, the link will be underlined when selected.                           |
