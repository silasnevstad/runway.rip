...
| color         | string            | `"primary"` | Color used for the toggle switch (see [tailwind.config](/docs/features/config#color-theme)).              |
| inactiveColor | string            | `"gray"`    | Inactive color used for the toggle switch (see [tailwind.config](/docs/features/config#color-theme)).     |
