...
| color         | string            | `"primary"` | Color used for the toggle switch (see [tailwind.config](/docs/tutorials/config)).              |
| inactiveColor | string            | `"gray"`    | Inactive color used for the toggle switch (see [tailwind.config](/docs/tutorials/config)).     |
